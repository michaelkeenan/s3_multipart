  ...
  function Upload() {
    ...
    this.init = function() {
      upload.initiateMultipart(upload, function(obj) {
        ...
        // mkeenan: moving this signPartRequest thing to .activate, so that the request time comes out correct for each part,
        // because otherwise you get RequestTimeTooSkewed errors for long requests
